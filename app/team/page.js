...
import image3 from '../public/assets/anamika3.jpeg' // Add image path for Anamika Mishra
    ...
    <>
      ...
      <div className={styles.bioContainer}>
        ...
        <div className={styles.infoContainer}>
          ...
          <p className={styles.bio} style={{textAlign: "justify"}}>
            Subhashish Kumar, the co-founder of Sahaj Nyay, is a graduate of the National Law Institute University,
